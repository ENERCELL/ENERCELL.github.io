...
var demo = new Demo({
    ...
    $("#js-points-data").append("Points outside circle: <span class='js-outer-points'>0</span><br />");
/*		$("#js-points-data").append("Pi estimation: <span class='js-pi-estimation'></span><br />"); */
    ...
    var outerPoints = this.totalPoints - this.innerPoints;
    $(".js-outer-points").html(outerPoints);
	...
	update: function(e){
		if (e == "speed"){
			...
			for (var i = 0 ; i < numberToAdd ; i++){
				...
				this.innerPoints++;
			    this.context.arc(this.scale(randomR*Math.cos(randomTheta)),this.scale(randomR*Math.sin(randomTheta)),3,0, 2*Math.PI);
				this.context.fill();
				this.totalPoints++;
				this.updateDisplay();
						}
